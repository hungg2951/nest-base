...
export interface UpdateProductInput {
  /** Product description (HTML allowed), shown on the storefront. */
  description?: string;
  /** SEO meta description, shown in search engine results. */
  metaDescription?: string;
  /** Short description, stored as a custom metafield (custom.short_description). */
...
export class ProductService {
  ...
  `;
    ...
    try {
      ...
      return {
        ...product,
        shortDescription: product?.metafield?.value ?? null,
      };
    } catch (error: any) {
